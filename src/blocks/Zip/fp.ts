export const FPProps = {
  labelInvalidField: '字段包含无效文件',
  labelFileWaitingForSize: '计算文件大小',
  labelFileSizeNotAvailable: '文件大小不可用',
  labelFileLoading: '加载',
  labelFileLoadError: '加载错误',
  labelFileProcessing: '压缩中...',
  labelFileProcessingComplete: '压缩完成',
  labelFileProcessingAborted: '压缩已取消',
  labelFileProcessingError: '压缩出错',
